...
#define  ClearDisplay(Color)                        BSP_LCD_Clear(Color)
#define  ClearStringLine(Line)                      BSP_LCD_ClearStringLine(Line)
#define  DisplayStringAtLine(Line, ptr)             BSP_LCD_DisplayStringAtLine(Line, ptr)
#define  DisplayStringAt(X, Y, pText)               BSP_LCD_DisplayStringAt(X, Y, pText, 3)
#define  DisplayChar(Xpos, Upos, Ascii)             BSP_LCD_DisplayChar(Xpos, Ypos, Ascii)
